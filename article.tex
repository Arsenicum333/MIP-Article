...
\begin{wrapfigure}{r}{0.5\textwidth}  % 'r' for right alignment, adjust width accordingly
    \vspace{-1.5em}  % Move the image up
    \includegraphics[width=0.5\textwidth]{Figures/Types_of_RS.png}
...
\begin{wraptable}{r}{0.5\textwidth} % 'r' for right alignment, change the width as necessary
\vspace{-1.5em}  % Move the image up
\centering
...
\label{tab:engagement-retention}
\end{table}
...
Overall, NLP excels in sentiment analysis, while VCA is better suited for visual content matching. Combining both enhances recommendation systems.
