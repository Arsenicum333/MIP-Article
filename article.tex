...
\hspace*{2em}Streaming platforms use various types of recommendation systems, each designed to capture different aspects of user preference. The major categories include content-based systems, collaborative filtering, hybrid approaches and group recommendations. Branching of these types of recommender systems displayed in the figure \ref{fig:Types}

\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{Types_of_RS.pdf}
    \caption{Branching of Recommender System Types}
    \label{fig:Types}
\end{figure}
