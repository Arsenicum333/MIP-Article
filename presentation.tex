...
\subtitle{\vspace{3mm} Engineering Methods 2024/2025}

\title{The Use of Deep Learning for Personalized Recommendations in Video Streaming Services}

\date{\footnotesize November 2024}
...
\section{Main Part 2.0}

\begin{frame}[fragile=singleslide]\frametitle{Main Part 2.0}
\begin{itemize}
\item Nejaký text
...
\begin{frame}[fragile=singleslide]\frametitle{Slide only with picture}
...
\begin{frame}[fragile=singleslide]\frametitle{Summarise}
\begin{itemize}
